 ...
 */
ParticleParamsView ParticleParams::host_view() const
{
    ParticleParamsView result;
 ...
 */
ParticleParamsView ParticleParams::device_view() const
{
    REQUIRE(!device_defs_.empty());
    ParticleParamsView result;
    result.defs = device_defs_.device_view();
    ENSURE(result);
    return result;
}
