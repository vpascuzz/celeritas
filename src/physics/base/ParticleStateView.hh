...
//---------------------------------------------------------------------------//
//! \file ParticleStateView.hh
//---------------------------------------------------------------------------//
#ifndef physics_base_ParticleStateView_hh
#define physics_base_ParticleStateView_hh
 ...
 */
struct ParticleStateView
{
    span<ParticleStateVars> vars;
...
#endif // physics_base_ParticleStateView_hh
